...
if server then
  ...
  function Callback.triggerClient(name, source, cb, ...)
    ...
    TriggerClientEvent('murphy_camp:triggerCallback', source, name, currentRequestId, GetInvokingResource() or "unknown", ...)
  ...
  RegisterServerEvent('murphy_camp:responseCallback', executeResponse)

  RegisterServerEvent('murphy_camp:triggerCallback', function(name, requestId, fromRessource, ...)
    local source = source
    TriggerClientEvent('murphy_camp:responseCallback', source, requestId, fromRessource, executeCallback(name, source, ...))
  end)
  ...
  function Callback.triggerServer(name, cb, ...)
    ...
    TriggerServerEvent('murphy_camp:triggerCallback', name, currentRequestId, GetInvokingResource() or 'unknown', ...)
  ...
  RegisterNetEvent('murphy_camp:responseCallback', executeResponse)

  RegisterNetEvent('murphy_camp:triggerCallback', function(name, requestId, fromRessource, ...)
    TriggerServerEvent('murphy_camp:responseCallback', requestId, fromRessource, executeCallback(name, ...))
  end)
