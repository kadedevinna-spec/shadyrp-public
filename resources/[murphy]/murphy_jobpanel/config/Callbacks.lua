...
if server then
  ...
  function Callback.triggerClient(name, source, cb, ...)
    ...
    TriggerClientEvent('murphy_jobpanel:triggerCallback', source, name, currentRequestId, GetInvokingResource() or "unknown", ...)
  ...
  RegisterServerEvent('murphy_jobpanel:responseCallback', executeResponse)

  RegisterServerEvent('murphy_jobpanel:triggerCallback', function(name, requestId, fromRessource, ...)
    local source = source
    TriggerClientEvent('murphy_jobpanel:responseCallback', source, requestId, fromRessource, executeCallback(name, source, ...))
  end)
  ...
  function Callback.triggerServer(name, cb, ...)
    ...
    TriggerServerEvent('murphy_jobpanel:triggerCallback', name, currentRequestId, GetInvokingResource() or 'unknown', ...)
  ...
  RegisterNetEvent('murphy_jobpanel:responseCallback', executeResponse)

  RegisterNetEvent('murphy_jobpanel:triggerCallback', function(name, requestId, fromRessource, ...)
    TriggerServerEvent('murphy_jobpanel:responseCallback', requestId, fromRessource, executeCallback(name, ...))
  end)
