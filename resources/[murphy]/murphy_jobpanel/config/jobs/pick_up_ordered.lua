local JobData = {
    name = filename(),
    label = "Pickup",
    description = "Pick up packages in a specific order",
    steps = {
        {
...
if IsDuplicityVersion() then
    ...
    local deliveries = {
        { label = "Church", description = "Pick up the package at the specified location", Pos = vector3(-3312.757, -2826.725, -6.813381) },
        { label = "Twin Rocks", description = "Pick up the package at the specified location", Pos = vector3(-3956.079, -2140.656, -5.978973) },
        { label = "Ridgewood Farm", description = "Pick up the package at the specified location", Pos = vector3(-4773.722, -2723.127, -14.84364) },
        { label = "Rathskeller Fork", description = "Pick up the package at the specified location", Pos = vector3(-5217.904, -2120.502, 11.68457) },
        { label = "Tumbleweed", description = "Pick up the package at the specified location", Pos = vector3(-5498.94, -2932.629, -1.423192) },
        { label = "Gaptooth Breach", description = "Pick up the package at the specified location", Pos = vector3(-5987.83, -3229.936, -22.14742) },
        { label = "Benedict Point", description = "Pick up the package at the specified location", Pos = vector3(-5225.704, -3480.168, -21.56653) },
    }

    local PackageQuestList = {}
    local cachequestVehicle = nil
    local PickedupPackages = {}
    local questLocation = 0
    local iquest = 1
    local blips = {}
    local questpoints = {}
    ...
    function Utils.NewLocation(jobdata)
        if iquest > #deliveries then
            iquest = 1
        end
        local pos = deliveries[iquest].Pos
