local JobData = {
    name = filename(),
    label = "Mattock Cattle Driving",
    description = "Drive the herd from to Emerald",
    steps = {
        {
            action = "Initialisation",
            label = "Go get the cows",
            description = "The cows are in the field",
            coords = vector3(1297.5388, -814.1151, 76.4418),
            heading = 274.0,
        ...
        {
            action = "HerdCows",
            destination = vector3(1466.8406, -808.9674, 51.2286),
        },
        {
            action = "HerdCows",
            destination = vector3(1676.4229, -456.6191, 49.3287),
        },
        {
            action = "HerdCows",
            destination = vector3(1405.9280, -346.6387, 87.6919),
        },
        {
            action = "HerdCows",
            destination = vector3(1222.8629, -46.0342, 99.0621),
        },
                {
            action = "HerdCows",
            destination = vector3(1410.8665, 199.5396, 92.0124),
        },
                {
            action = "HerdCows",
            destination = vector3(1422.9291, 316.2834, 88.6817),
        },
        {
            action = "CompleteJob",
            reward = 200,
