local JobData = {
    name = filename(),
    label = "Valentine Auction Yard",
    description = "Drive the herd to the Valentine Auction Yard",
    steps = {
        {
        ...
        {
            action = "HerdCows",
            destination = vector3(1194.7494, 244.2825, 95.3148),
        },
        {
            action = "HerdCows",
            destination = vector3(1031.1401, 402.5695, 104.2011),
        },
        {
            action = "HerdCows",
            destination = vector3(502.7815, 368.3588, 107.9703),
        },
        {
            action = "HerdCows",
            destination = vector3(-149.6728, 581.6431, 112.8813),
        },
                {
            action = "HerdCows",
            destination = vector3(-225.9518, 642.6962, 113.2581),
        },
        {
            action = "CompleteJob",
            reward = 200,
