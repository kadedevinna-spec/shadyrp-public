    ...
    steps = {
        {
            ...
            description = "The cows are ready to go!",
            coords = vector3(-837.1924, 332.6605, 95.7458),
            heading = 274.0,
        ...
        {
            action = "HerdCows",
            destination = vector3(-808.9252, 281.6809, 94.5982),
        },
        {
            action = "HerdCows",
            destination = vector3(-1096.8757, 166.3357, 59.3324),
        },
        {
            action = "HerdCows",
            destination = vector3(-1034.0885, 427.0760, 55.5021),
        },
        {
            action = "HerdCows",
            destination = vector3(-1129.2830, 466.5269, 57.7929),
        },
        {
            action = "HerdCows",
            destination = vector3(-1261.7222, 258.6208, 58.6309), 
        },
        {
            action = "HerdCows",
        ...
        {
            action = "HerdCows",
            destination = vector3(-2620.5493, 390.0485, 145.9289),
        },
        {
            action = "CompleteJob",
            reward = 200,
