...
[1] = {EFFECT_NAME = "METABOLISM_EFFECT_HORSE_NOT_REACTING_TO_CALL" , LABEL = "No reaction to calls"  	, ENABLED = false,  COMPARISON = "INFERIOR", HUNGER = 40, THIRST = 40, LOVE = false }, -- IF LOVE_THRESHOLD < 50 or HUNGER_AND_THIRST_THRESHOLD < 100 THEN IT WILL ENABLE THAT EFFECT IN GAME
[2] = {EFFECT_NAME = "METABOLISM_EFFECT_HORSE_LOWERING_HEAD" 		, LABEL = "Lower head" 		        , ENABLED = false,  COMPARISON = "INFERIOR", HUNGER = 40, THIRST = 40, LOVE = false },
[3] = {EFFECT_NAME = "METABOLISM_EFFECT_HORSE_NOT_FOLLOWING" 		, LABEL = "Refuse to follow" 	  	, ENABLED = false,  COMPARISON = "INFERIOR", HUNGER = 10, THIRST = 10, LOVE = false },
