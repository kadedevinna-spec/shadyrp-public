...
[3] = { 
			  ...
			  ---------------------------------
			  ---------------------------------
			  LUNGING_START_PLAYER_COORDS   = vector4(-4794.81, -2682.95, -12.77, 0.0),
			  LUNGING_OBSTACLES_ENABLED     = false, 			  
			  LUNGING_OBSTACLES             = { 
			  [1]  = {ENABLED = true, MODEL = "P_HAYBALESTACK01X", COORDS = vector4(-4801.72, -2682.67, -13.56,  0.0  ) },        
			  },			  
...
-- MCFARLANE RANCH 
      [6] = { 
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "stillwaters",  XPGIVEN = {ONMOUNT = 30, LEADING = 30, LUNGING = 10}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 30, LEADING = 30 , LUNGING = 10},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 120, LUNGING = 60},
			  BLIPENABLED 				= true,
			  BLIPSPRITE      			= -1327110633,
			  BLIPNAME        		    = "HORSE TRAINING",	  
			  BLIPCOORDS                = vector3(-2438.0625, -2367.9077, 61.2255),	
			  PROMPTNAME                = "MCFARLANE RANCH STABLES",			  
			  PROMPTCOORDS              = vector3(-2438.0625, -2367.9077, 61.2255), 
			  PROMPTDISTANCE            = 5.0,
			  MUSICENABLED              = true,
			  MUSICUSED                 = "BOU1_START",	
			  ---------------------------------
			  ...
			  STARTPLAYERCOORDS         = vector4(-2438.0625, -2367.9077, 60.1717, 199.5714),
			  CHECKPOINTS               = {
			  [1]  = { COORDS = vector3(-2438.4163, -2369.8801, 60.1717), DETECTIONDISTANCE = 3.0 , RGB = {198,34,34}},
			  [2]  = { COORDS = vector3(-2426.1406, -2382.7729, 61.2255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [3]  = { COORDS = vector3(-2421.2402, -2352.1238, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [4]  = { COORDS = vector3(-2439.7095, -2353.5818, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [5]  = { COORDS = vector3(-2442.6665, -2379.2927, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [6]  = { COORDS = vector3(-2446.0176, -2402.0964, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [7]  = { COORDS = vector3(-2469.7346, -2398.6570, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [8]  = { COORDS = vector3(-2476.4966, -2374.8030, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [9]  = { COORDS = vector3(-2449.0034, -2385.9695, 61.7255), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [10] = { COORDS = vector3(-2435.3027, -2376.7554, 60.1717), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  [11] = { COORDS = vector3(-2438.0625, -2367.9077, 60.1717), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138}},
			  },
...
-- VALENTINE 
	...
	-- Still Waters 
      [9] = { 
			  ...
			  JOB_LIST                  = {
			 -- [1] = {TRAINING_ACCESS = true, LABEL = "OTHER_JOBS",  XPGIVEN = {ONMOUNT = 30, LEADING = 30, LUNGING = 10}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
			  [1] = {TRAINING_ACCESS = true, LABEL = "stillwaters",  XPGIVEN = {ONMOUNT = 100, LEADING = 30, LUNGING = 10}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 30, LEADING = 30 , LUNGING = 10},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 120, LUNGING = 60},	
			  BLIPENABLED 				= false,
			  BLIPSPRITE      		    = -1327110633,
			  BLIPNAME        			= "HORSE TRAINING",	
			  BLIPCOORDS                = vector3(2257.9082, -125.6326, 45.8032), 	
			  PROMPTNAME                = "Still Waters",			  
			  PROMPTCOORDS              = vector3(2257.9082, -125.6326, 45.8032), 
			  PROMPTDISTANCE            = 5.0, 
			  MUSICENABLED              = false,
			  MUSICUSED                 = "BOU1_START",	
			  ---------------------------------
			  ...
			  OBSTACLES_ENABLED         = true,  
			  OBSTACLES         		= { 
			  [1]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2261.3623046875, -27.68870544433593, 49.72219848632812, -72.71896362304688) },   
			  [2]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2250.49169921875, 5.04797649383544, 50.07025146484375, 38.87697982788086) },   
			  [3]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2221.551025390625, 12.0151891708374, 51.45501327514648, -48.07786178588867) },   
			  [4]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2194.72119140625, -3.47454094886779, 51.16197204589844, 124.6837) },  
			  [5]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2179.28125, -7.5291142463684, 51.53989028930664, 108.0008) }, 
			  [6]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2162.139892578125, -25.01075935363769, 53.9755973815918, 207.6208) },    
			  [7]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(2174.4453125, -50.96134185791015, 53.6458511352539, -114.69940185546875) }, 
              --[8]  = {ENABLED = true, MODEL = "MP001_P_MP_JUMP_HAYBALESHORT01",	COORDS = vector4(0.0, 0.0, 0.0, 0.0) },     
			  ...
			  STARTPLAYERCOORDS         = vector4(2258.1809, -125.6772, 44.9357, 345.8054),
			  CHECKPOINTS               = {
			  [1]  = { COORDS = vector3(2261.8772, -102.900, 44.9357), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [2]  = { COORDS = vector3(2284.0200, -69.0663, 44.9357), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [3]  = { COORDS = vector3(2272.5698, -70.6272, 44.9357), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [4]  = { COORDS = vector3(2267.1577, -83.8782, 44.9357), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},
			  [5]  = { COORDS = vector3(2263.2888, -74.9212, 44.9357), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [6]  = { COORDS = vector3(2263.6877, -64.8537, 46.6056), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [7]  = { COORDS = vector3(2247.3584, -82.3899, 45.5824), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [8]  = { COORDS = vector3(2244.3889, -78.6361, 46.0850), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [9]  = { COORDS = vector3(2264.7451, -65.6190, 45.5068), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
              [10] = { COORDS = vector3(2244.1669, -52.2568, 48.5536), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
              [11] = { COORDS = vector3(2261.3623, -27.6887, 50.9142), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [12] = { COORDS = vector3(2250.4916,   5.0479, 51.2107), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [13] = { COORDS = vector3(2238.8791,  27.7360, 52.9212), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [14] = { COORDS = vector3(2221.5510,  12.0151, 52.6639), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [15] = { COORDS = vector3(2194.7211,  -3.4745, 52.3352), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},
              [16] = { COORDS = vector3(2179.2812,  -7.5291, 52.6796), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [17] = { COORDS = vector3(2160.0515,  -9.0810, 54.6340), DETECTIONDISTANCE = 3.0, RGB = {250,250,250}},
			  [18] = { COORDS = vector3(2162.1398, -25.0107, 55.4157), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [19] = { COORDS = vector3(2174.4777, -50.8949, 55.0600), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [20] = { COORDS = vector3(2207.7319, -105.629, 49.8198), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [21] = { COORDS = vector3(2172.5979, -118.510, 50.8824), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [22] = { COORDS = vector3(2179.2453, -118.022, 50.8734), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [23] = { COORDS = vector3(2179.2709, -101.167, 50.9916), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [24] = { COORDS = vector3(2187.2021, -100.572, 50.2833), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [25] = { COORDS = vector3(2218.3808, -123.495, 47.0460), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
			  [26] = { COORDS = vector3(2258.1809, -125.677, 44.9357), DETECTIONDISTANCE = 2.0, RGB = {250,250,250}},			  
