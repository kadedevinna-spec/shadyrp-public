...
----------------------------------- 
-----------------------------------   
Config.STASH_WHITELIST_ITEMS_TABLE = { 			-- If Config.whitelistItems == true set the items here 
{item = "consumable_haycube", limit = 10}, 
}

Config.STASH_WHITELIST_WEAPONS_TABLE = { 		-- If Config.whitelistWeapons == true set the weapons here 
{item = "WEAPON_REVOLVER_CATTLEMAN", limit = 1}, 
}

Config.STASH_BLACKLIST_TABLE = { 				-- If Config.UseBlackList == true set the items here.  
{item = "consumable_sugarcube"},
{item = "consumable_carrot"},
}
 
Config.STASH_PERMISSIONS = { 	 				-- If Config.UsePermissions == true set the items here.  
{job = "horsetrainer", grade = 1},
}
