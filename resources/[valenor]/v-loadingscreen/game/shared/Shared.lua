...
Config.ValenorKey = "valenor=zMPz04EqjBN05shNLDXv1MQwZ6NxDnqVyF9vsPlGMmu7bAUqzlDBWFZR" -- discord.gg/valenorstudio

Config.ServerName = "ShadyDev"
Config.ServerSuffix = "Development"
...
Config.Hints = {
    ...
    'When hunting, pay attention to the wind direction — animals can smell you.',
    ...
    'Dead Eye is a powerful ability in gunfights — dont forget to use it!'
}
