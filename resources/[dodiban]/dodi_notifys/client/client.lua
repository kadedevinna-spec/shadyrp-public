...
TriggerEvent('dodi_notifys:NotifyLeft', "first text", "second text", "generic_textures", "tick", 4000)
TriggerEvent('dodi_notifys:Tip', "your text", 4000)
TriggerEvent('dodi_notifys:NotifyTop', "your text", "TOWN_ARMADILLO", 4000)
TriggerEvent('dodi_notifys:ShowSimpleRightText', "your text",  4000)
TriggerEvent('dodi_notifys:ShowObjective', "your text", 4000)
TriggerEvent('dodi_notifys:ShowTopNotification', "your text", "your text", 4000)
TriggerEvent('dodi_notifys:ShowAdvancedRightNotification', "your text", "generic_textures" , "tick" , "COLOR_PURE_WHITE", 4000)
TriggerEvent('dodi_notifys:ShowBasicTopNotification', "your text", 4000)
TriggerEvent('dodi_notifys:ShowSimpleCenterText', "your text", 4000)

TriggerEvent('dodi_notifys:FailMission', "título", "subtítulo", 4000)
TriggerEvent('dodi_notifys:DeadPlayer', "título", "audio_ref", "audio_name", 4000)
TriggerEvent('dodi_notifys:Warning', "título", "mensagem", "audio_ref", "audio_name", 4000)

RegisterNetEvent('dodi_notifys:NotifyLeft')
AddEventHandler('dodi_notifys:NotifyLeft', function(firsttext, secondtext, dict, icon, duration)
    local _dict = dict
    local _icon = icon
    ...
    exports.dodi_notifys:ShowAdvancedNotification(tostring(firsttext), tostring(secondtext), tostring(_dict), tostring(_icon), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:Tip')
AddEventHandler('dodi_notifys:Tip', function(text, duration)
    exports.dodi_notifys:ShowTooltip(tostring(text), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:NotifyTop')
AddEventHandler('dodi_notifys:NotifyTop', function(text, location, duration)
    exports.dodi_notifys:ShowLocationNotification(tostring(text), tostring(location), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:ShowSimpleRightText')
AddEventHandler('dodi_notifys:ShowSimpleRightText', function(text, duration)
    exports.dodi_notifys:ShowSimpleRightText(tostring(text), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:ShowObjective')
AddEventHandler('dodi_notifys:ShowObjective', function(text, duration)
    exports.dodi_notifys:ShowObjective(tostring(text), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:ShowTopNotification')
AddEventHandler('dodi_notifys:ShowTopNotification', function(tittle, subtitle, duration)
    exports.dodi_notifys:ShowTopNotification(tostring(tittle), tostring(subtitle), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:ShowAdvancedRightNotification')
AddEventHandler('dodi_notifys:ShowAdvancedRightNotification', function(text, dict, icon, text_color, duration)
    local _dict = dict
    local _icon = icon
    if not LoadTexture(_dict) then
        _dict = "generic_textures"
    ...
    exports.dodi_notifys:ShowAdvancedRightNotification(tostring(text), tostring(_dict), tostring(_icon), tostring(text_color), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:ShowBasicTopNotification')
AddEventHandler('dodi_notifys:ShowBasicTopNotification', function(text, duration)
    exports.dodi_notifys:ShowBasicTopNotification(tostring(text), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:ShowSimpleCenterText')
AddEventHandler('dodi_notifys:ShowSimpleCenterText', function(text, duration)
    exports.dodi_notifys:ShowSimpleCenterText(tostring(text), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:FailMission')
AddEventHandler('dodi_notifys:FailMission', function(title, subtitle, duration)
    exports.dodi_notifys:failmissionnotif(tostring(title), tostring(subtitle), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:DeadPlayer')
AddEventHandler('dodi_notifys:DeadPlayer', function(title, audioRef, audioName, duration)
    exports.dodi_notifys:deadplayernotif(tostring(title), tostring(audioRef), tostring(audioName), tonumber(duration))
end)

RegisterNetEvent('dodi_notifys:Warning')
AddEventHandler('dodi_notifys:Warning', function(title, msg, audioRef, audioName, duration)
    exports.dodi_notifys:warninnotify(tostring(title), tostring(msg), tostring(audioRef), tostring(audioName), tonumber(duration))
end)
