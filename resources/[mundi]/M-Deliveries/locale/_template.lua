-- ╔═════════════════════════════════════════════════════════════════════════════╗
-- ║         M-DELIVERIES - LOCALE TEMPLATE                                      ║
-- ║                                                                             ║
-- ║  HOW TO USE:                                                                ║
-- ║  1. Copy this file and rename it to your language code                      ║
-- ║     Example: de.lua (German), it.lua (Italian), etc.                        ║
-- ║  2. Change "xx" below to your language code (e.g. "de")                     ║
-- ║  3. Translate the strings on the RIGHT side of each =                       ║
-- ║  4. Do NOT change the key names on the LEFT side                            ║
-- ║  5. Do NOT remove/change the %s or %d or \ placeholders they are variables  ║
-- ║  6. Keep HTML tags like <strong> and <em> intact                            ║
-- ║  7. Set Config.Core.language in config.lua to your code                     ║                             
-- ╚═════════════════════════════════════════════════════════════════════════════╝
