            ...
            <div class="menu-items">
                    ...
                    <div class="grid-container">
                        {{#elements}}
                            <div class="grid-item {{#selected}}selected{{/selected}}">
                                {{#image}}
                                    <img src="nui://v-inventory/web/dist/items/{{{image}}}.png" onerror="this.onerror=null;this.src='nui://mosquito-mining-blacksmithing/item_imgs/{{{image}}}.png'"></img>
                                {{/image}}
                                {{^image}}
                ...
                {{^isGrid}}
                    {{#elements}}
                        ...
                        {{/isNotSelectable}}
                            {{#image}}
                                <img class="item-image" src="nui://v-inventory/web/dist/items/{{{image}}}.png" onerror="this.onerror=null;this.src='nui://mosquito-mining-blacksmithing/item_imgs/{{{image}}}.png'"></img>
                            {{/image}}
